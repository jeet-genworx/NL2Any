...
from query_processing.models.pipeline import GeneratedQuery, MongoQuery, QueryPlan, RelevantSchema
...
DEFAULT_MONGO_PROMPT = Path("query_processing/prompts/mongo_query_generator.txt")
